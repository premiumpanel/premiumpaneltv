...
import HeaderTen from '~/layouts/headers/HeaderTen.vue'
import FooterTen from '~/layouts/footers/FooterTen.vue'

useHead({
  title: "Home 11 - Lexend - Software, SaaS & Startup Nuxt js Template",
    meta: [
...
onMounted(async () => {
  const css = await import('~/assets/css/theme/theme-eleven.purge.css?inline')
...
<template>
  <div class="uni-body panel bg-white text-tertiary-900 dark:bg-gray-900 dark:text-gray-200 overflow-x-hidden disable-cursor">
    <HeaderTen />
    <div id="wrapper" class="wrap">
      <HomesHome11HeroArea />
      <HomesHome11KeyFeatures />
      <HomesHome11IntegrationArea />
      <HomesHome11PricingArea />
      <HomesHome11TestimonialArea />
      <HomesHome11FaqArea />        
    </div>
    <FooterTen />
  </div>
