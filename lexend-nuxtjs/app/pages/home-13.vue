...
useHead({
  title: "Home 13 - Lexend - Software, SaaS & Startup Nuxt js Template",
    meta: [
...
onMounted(async () => {
  const css = await import('~/assets/css/theme/theme-thirteen.purge.css?inline')
...
<template>
  <div class="uni-body panel uni-body panel bg-white text-tertiary-900 dark:bg-gray-900 dark:text-gray-200 overflow-x-hidden disable-cursor">
    <HeaderTwelve />
    <div id="wrapper" class="wrap">
      <HomesHome13HeroArea />         
      <HomesHome13BrandsArea />         
      <HomesHome13FeaturesArea />         
      <HomesHome13Service />         
      <HomesHome13PricingArea />         
      <HomesHome13FaqArea />         
      <HomesHome13BlogArea />         
      <HomesHome13CtaArea />         
    </div>
