...
useHead({
  title: "Career Details - Lexend - Software, SaaS & Startup Nuxt js Template",
})
...
<template>
  <div
    ...
    <div id="wrapper" class="wrap">
      <CareerDetailsHeroArea />
      <CareerDetailsJobDetailsArea />
      <PageCareerOpening />
      <PageCareerTestimonialArea />
      <PageCareerBrandsArea /> 
    </div>
    <FooterTwo />
  </div>
</template>