...
useHead({
  title: "Blog Author - Lexend - Software, SaaS & Startup Nuxt js Template",
})
...
<template>
  <div class="uni-body panel bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-200 overflow-x-hidden disable-cursor">
    ...
    <div id="wrapper" class="wrap">
      <CommonBreadcrumbTwo :style_2="true" title="Blog" pagelink="blog" subtitle="Amir Lawyer" />
      <BlogCategoryArea :style_2="true" />      
      <BlogNewsletter />
    </div>
    <FooterTwo />
  </div>  
