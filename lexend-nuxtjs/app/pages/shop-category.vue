...
useHead({
  title: "Shop - Lexend - Software, SaaS & Startup Nuxt js Template",
})
...
<template>
  <div
    ...
    <div id="wrapper" class="wrap"> 
      <CommonBreadcrumbTwo :style_2="true" title="Shop" pagelink="shop" subtitle="Toys" />
      <ShopDetailsShopCategoryArea />             
    </div>
    <FooterTwo />
  </div>
</template>