...
useHead({
  title: "Home 2 - Lexend - Software, SaaS & Startup Nuxt js Template",
    meta: [
...
<template>
  <div
    ...
    <div id="wrapper" class="wrap">
      <HomesHome2HeroArea />
      <HomesHome2FeaturesArea />
      <HomesHome2KeyFeaturesArea />
      <HomesHome2PricingArea />
      <PageFeaturesFaqArea  :style_2="true"  :style_3="true"  /> 
      <AboutFeedbacks />  
      <HomesHome2BlogArea />
      <HomesHome2CtaArea />
    </div>
    <FooterTwo :style_footer="true" />
  </div>
</template>